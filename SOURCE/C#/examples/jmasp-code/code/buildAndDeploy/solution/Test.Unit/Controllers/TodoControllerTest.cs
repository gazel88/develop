...
namespace Test.Unit.Controllers
{
    ...
    public class TodoControllerTest
    {
      ...
      private BloggerGateway gateway;
      ...
      public void setup()
      {
        ...
        gateway = mocks.Stub<BloggerGateway>(); 
        todoController = new TodoController(todoRepository, gateway); 
      ...
      public void Should_Display_Todo_List_And_Logged_In_Users_Name()
      {
        ...
        builder.HttpContext.Request.Expect(x => x.Headers)
